    ...
    def __init__(self, root):
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Colombo":
                    switch = {"Gampaha": 10, "Kalutara": 8, "Horana": 6, "Colombo": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Gampaha":
                    switch = {"Gampaha": 0, "Kalutara": 2, "Horana": 5, "Colombo": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Kalutara":
                    switch = {"Gampaha": 2, "Kalutara": 0, "Horana": 3, "Colombo": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Horana":
                    switch = {"Gampaha": 5, "Kalutara": 3, "Horana": 0, "Colombo": 6}
                    Km.set(switch[varl2.get()])
        ...
        self.cboPickup = ttk.Combobox(TravelFrame, textvariable=varl1, state='readonly', font=('arial', 20, 'bold'),
                                      width=14)
        self.cboPickup['value'] = ('', 'Colombo', 'Horana', 'Kalutara', 'Gampaha')
        self.cboPickup.current(0)
        ...
        self.cboDrop = ttk.Combobox(TravelFrame, textvariable=varl2, state='readonly', font=('arial', 20, 'bold'),
                                    width=14)
        self.cboDrop['value'] = ('', 'Gampaha', 'Kalutara', 'Colombo', 'Horana')
        self.cboDrop.current(0)
